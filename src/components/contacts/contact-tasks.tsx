...
const tasks = [
  ...
  {
    id: "3",
    title: "Send listing recommendations",
    description: "Compile list of properties matching criteria",
    status: "completed",
    priority: "low",
...
export function ContactTasks({ id }: ContactTasksProps) {
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage and track tasks related to this contact
          </p>
        </div>
        <Button>
