...
const activities = [
  {
    ...
    description: "Sent property listing details",
  ...
  },
  {
    ...
    description: "Showed 123 Main Street",
  ...
  },
  {
    ...
    type: "note",
    title: "Meeting Notes",
    description: "Interested in 3-bedroom properties",
  ...
  },
  {
    ...
    type: "message",
    title: "Text Message",
    description: "Confirmed next viewing appointment",
  ...
  },
  {
    ...
    description: "$450,000 for 123 Main Street",
    date: new Date(2024, 2, 8, 13, 20),
    icon: DollarSign,
  },
]
...
export function ContactActivity({ id }: ContactActivityProps) {
  return (
