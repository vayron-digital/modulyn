...
export const colorSchemeConfigs: Record<ColorScheme, ColorSchemeConfig> = {
  zinc: {
    light: {
      background: "0 0% 100%",
...
interface AppearanceState {
  ...
  isNavigationAnimated: boolean
  isCardAnimated: boolean
  isDimInactive: boolean
  setFontSize: (size: FontSize) => void
  setBorderRadius: (radius: BorderRadius) => void
  setColorScheme: (scheme: ColorScheme) => void
  setReducedMotion: (enabled: boolean) => void
  setReducedTransparency: (enabled: boolean) => void
  setNavigationAnimated: (enabled: boolean) => void
  setCardAnimated: (enabled: boolean) => void
  setDimInactive: (enabled: boolean) => void
}
...
export const useAppearanceStore = create<AppearanceState>()(
  persist(
    (set) => ({
      ...
      setNavigationAnimated: (enabled) => set({ isNavigationAnimated: enabled }),
      setCardAnimated: (enabled) => set({ isCardAnimated: enabled }),
      setDimInactive: (enabled) => set({ isDimInactive: enabled }),
    }),
    {
